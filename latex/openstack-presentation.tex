  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item \em{Programs} $\rightarrow$ \em{Project Teams}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item \em{Active Technical Contributor}: Active Technical Contribur
      ...
      \item \em{Core reviewer} : ATC ayant les droits pour valider les patchs dans un projet
