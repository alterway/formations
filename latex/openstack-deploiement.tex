...
\end{verbatim}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item Éphémère
      \item Une flavor
      \item Consruite à partir d'une image
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Définit un modèle d'instance en termes de CPU, RAM, disque, disque éphémère
    \end{itemize}
  \end{frame}
...
\end{verbatim}
  ...
  \begin{frame}
    \frametitle{Principes}
    \begin{itemize}
      \item \em{Software Defined Networking} (SDN)
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item Réseau (\em{network}) : niveau 2
      \item Sous-réseau (\em{subnet}) : niveau 3
...
\end{verbatim}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item Swift : très bonne gestion en mode \em{rolling upgrade}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Depuis Juno : \em{Distributed Virtual Router} (DVR)
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Veille sur les failles de sécurité : OSSA (\em{OpenStack Security Advisory})
    \end{itemize}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item L'appel API \em{reset-state} peut servir
    \end{itemize}
  \end{frame}
