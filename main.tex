...
\logo{\includegraphics[height=0.5cm]{logo-osones.png}}
...
\end{verbatim}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Développement hyper actif\pause
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Quelques centaines au début à plusieurs milliers de participants aujourd'hui
